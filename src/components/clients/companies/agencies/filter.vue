  ...
  export default {
    ...
    methods: {
        ...
        removeFilter(){
            ...
            localStorage.removeItem("selectorFiltersAgencies")
            localStorage.removeItem("filtersAgencies")
            localStorage.removeItem("filtersAgenciesLength")
            this.$nextTick(() => {
                this.$emit("filterAgencies", false);
            })
        },
        filter(){
            var count = 0
            ...
            //save
            localStorage.setItem('selectorFiltersAgencies', JSON.stringify(this.company));
            localStorage.setItem('filtersAgencies', JSON.stringify(filter.slice(1,filter.length)));
            localStorage.setItem('filtersAgenciesLength', count)
    ...
    created(){
        if(localStorage.getItem('selectorFiltersAgencies')!=undefined){
            this.quotation = JSON.parse(localStorage.getItem('selectorFiltersAgencies'))
        }
    },
  }
</script>