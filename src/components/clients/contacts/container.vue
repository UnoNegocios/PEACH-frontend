                ...
                <v-menu :nudge-width="250" :close-on-content-click="false"  offset-x>
                    ...
                    <v-card>
                        <v-list>
                            <v-list-item>
                                <v-list-item-avatar>
                                    <img :src="filesLink + 'files/default.jpg'">
                                </v-list-item-avatar>
                                <v-list-item-content>
                        ...
                        <v-row class="pa-4">
                            <v-col cols="12" md="5">
                                <span @click="whatsapp(contact.phone)" style="font-size:14px; color:#c57de4; cursor: pointer;"><v-icon small color="#c57de4" class="mr-2">mdi-phone</v-icon>{{contact.phone}}</span>
                            </v-col>
                            <v-col cols="12" md="7">
                                <span v-bind:href="'mailto:'+contact.email" style="font-size:14px; color:#c57de4; cursor: pointer;"><v-icon small color="#c57de4" class="mr-2">mdi-email</v-icon>{{contact.email}}</span>
                            </v-col> 
                        </v-row>
                    </v-card>
                </v-menu>
