    ...
    <v-card>
        <v-card-title class="pb-0 pt-1" >
            ...
            <v-col cols="12" sm="6" md="4">
                <v-autocomplete v-if="permissions('assignNotes')" :rules="[v => !!v || 'Campo requerido']" clearable v-model="note.to_user_id" :items="usersLists" label="Responsable" item-text="name" item-value="id">
