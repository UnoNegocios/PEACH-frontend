        ...
        date_filter:{
            handler(){
                if(this.date_filter!=null && this.date_filter.length==2){
                    ...
                    axios.get(process.env.VUE_APP_BACKEND_ROUTE + 'api/v1/reports?subject=agencies&include=agency&filter[deadline_date_between]='+this.date_filter).then(response=>{
